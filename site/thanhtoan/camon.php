...
if(isset($_GET['partnerCode'])){
		...
		$insert_order = "INSERT INTO `order`(id_user,code_cart,status,total,time,ship_address,ship_name_user,ship_phone_user,pttt)
			...
			echo '<p  class=" text-center text-[32px] ">Vui lòng vào trang  <a style="color:red"  href="index.php?act=detail_order" ><span class="text-red bg-black-300" >Đơn hàng của tôi</span></a> để xem chi tiết đơn hàng của bạn</p>';
	}
?>
